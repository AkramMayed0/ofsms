...
- Name: 03-quran-reports.spec.js >> تقارير حفظ القرآن >> مشرف يوافق على تقرير الحفظ
- Location: e2e\03-quran-reports.spec.js:30:3
...
Locator: locator('.approve-btn, button[title="موافقة"]').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('.approve-btn, button[title="موافقة"]').first()
